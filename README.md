...
# Requirements
- Entire map is made using a TileSet
- Player and Enemy characters have proper movement physics with collisions
- Player and Enemy both have animated sprites
- Enemy will continuously pathfind towards player
- Particle effects are shown when a circuit is collected and when the player is hit
- Collectible circuit boards are shown around the map with animations
- UI feedback for score
